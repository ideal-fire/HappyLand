...
if (Lang==1) then
	SetSpell(GetSpell(0),MallocString("Ice"),0,12,MallocString("app0:Stuff/Spell/Ice.png"),6);
elseif (Lang==2) then
	SetSpell(GetSpell(0),MallocString("Hielo"),0,12,MallocString("app0:Stuff/Spell/Ice.png"),6);
end
...
if (Lang==1) then
	SetSpell(GetSpell(1),MallocString("Drink Water"),-10,0,MallocString("app0:Stuff/Spell/DrinkWater.png"),0,1);
elseif (Lang==2) then
	SetSpell(GetSpell(1),MallocString("Beber Agua"),-10,0,MallocString("app0:Stuff/Spell/DrinkWater.png"),0,1);
end
...
if (Lang==1) then
	SetSpell(GetSpell(2),MallocString("Heal"),-20,0,MallocString("app0:Stuff/Spell/Heal.png"),3,1);
elseif (Lang==2) then
	SetSpell(GetSpell(2),MallocString("Curar"),-20,0,MallocString("app0:Stuff/Spell/Heal.png"),3,1);
end
...
if (Lang==1) then
	SetSpell(GetSpell(3),MallocString("Throw Tree"),16,0,MallocString("app0:Stuff/Spell/ThrowTree.png"),10);
elseif (Lang==2) then
	SetSpell(GetSpell(3),MallocString("Lanzar 'arbol"),16,0,MallocString("app0:Stuff/Spell/ThrowTree.png"),10);
end
...
if (Lang==1) then
	SetSpell(GetSpell(4),MallocString("Carrot Drill"),0,16,MallocString("app0:Stuff/Spell/CarrotDrill.png"),10);
elseif (Lang==2) then
	-- Taladro De Zanahoria??
	SetSpell(GetSpell(4),MallocString("Zanahoria"),0,16,MallocString("app0:Stuff/Spell/CarrotDrill.png"),10);
end
